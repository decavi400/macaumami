...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        //BaseUrl = "http://140.124.77.179:1111/upload/ck/content";
        BaseUrl = "../upload/ck/content";


        
		// The phisical directory in the server where the file will end up. If
		// blank, CKFinder attempts to resolve BaseUrl.
		//BaseDir = "D:/ghost/upload/ck/content";
        BaseDir = HttpContext.Current.Server.MapPath("~//") + "upload/ck/content";
